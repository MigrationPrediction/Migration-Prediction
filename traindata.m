function [inputs,targets] = traindata
...
inputs = K;
targets = [A{1}.D A{2}.D A{3}.D A{4}.D A{5}.D A{6}.D A{7}.D A{8}.D A{9}.D A{10}.D A{11}.D A{12}.D A{13}.D A{14}.D A{15}.D A{16}.D A{17}.D A{18}.D A{19}.D A{20}.D A{21}.D A{22}.D A{23}.D];
end