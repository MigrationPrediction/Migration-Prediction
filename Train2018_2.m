...
xlswrite('Feature1090_2b.xlsx', prcerror1,4,strcat('A',num2str(1)));
xlswrite('Feature1090_2b.xlsx', minerror,6,strcat('A',num2str(1)));
...
non(delete) = [];
xlswrite('Feature1090_2b.xlsx', prcerror(:,im)',strcat('A',num2str(ik),':CK',num2str(ik)));
xlswrite('Feature1090_2b.xlsx', deleteno, 2, strcat('A',num2str(ik)));
xlswrite('Feature1090_2b.xlsx', minerror, 5, strcat('A',num2str(ik)));
xlswrite('Feature1090_2b.xlsx', maxerror, 3, strcat('A',num2str(ik)));
end
